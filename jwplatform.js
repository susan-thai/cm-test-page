...
*/
;console.log('SLOGS!!! OVER RIDING JWPLATFORM LIBRARY!!!------------------');
!function() {
    var t,
        e,
        n = {
            ...
            5083: function(t, e, n) {
                ...
                e.ZP = function(t, e) {
                    ...
                    var v = (0, r.l7)({}, l, d);
                    "." === v.base && (v.base = (0, o.getScriptPath)("jwplayer.js")),
                    ...
                    var b = v.playlist;
                    if (b)
                        Array.isArray(b.playlist) && (v.feedData = b, v.playlist = b.playlist);
                    else {
            ...
            623: function(t, e, n) {
                ...
                (0, r.l7)(J.prototype, {
                    ...
                    init: function(t, e) {
                        ...
                        (0, r.l7)(this.mediaShim, V.L4);
                        var c = t,
                            s = (0, o.ZP)((0, r.l7)({}, t), a);
                        s.id = e.id,
                        s.setupConfig = c,
                        (0, r.l7)(i.attributes, s, V.bv),
                        ...
                        return i.on("change:errorEvent", $), this.setup.start(e).then((function(t) {
                            ...
                            n.setup && function(t, e, n) {
                                Promise.resolve().then((function() {
                                    ...
                                    if (!o) {
                                        var u = (0, W.Z)(t, r);
                                        W.Z.cloneIcon && u.querySelector(".jw-icon").appendChild(W.Z.cloneIcon("error")),
                                        tt(t, u)
                                    }
                                    i.set("errorEvent", r),
                                    i.set("state", y.Vy),
                    ...
                    playerDestroy: function() {
                        ...
                        this.currentContainer !== this.originalContainer && tt(this, this.originalContainer),
                        this.off(),
                        ...
                        for (var a = [], c = 0; c < (0, r.my)(e); c++) {
                            ...
                            if ("media" === s.prefix) {
                                ...
                                case "subtitle":
                                    ...
                                    (0, i.Dc)(s, "lang").length > 0 && (d.label = o((0, i.Dc)(s, "lang"))),
                                    a.push(d)
                                }
                            }
                        }
            ...
            393: function(t, e, n) {
                ...
                var u = function(t) {
                    ...
                    s = function(t) {
                        ...
                        e.sources !== Object(e.sources) || c(e.sources) || (e.sources = [(0, i.Z)(e.sources)]),
                        c(e.sources) && 0 !== e.sources.length || (t.levels ? e.sources = t.levels : e.sources = [(0, i.Z)(t)]);
            ...
            8320: function(t, e, n) {
                ...
                function d(t, e, n) {
                    ...
                    if (a.preload = o(e.preload, u), a.allSources = v(a, t), a.sources = g(a.allSources, i), a.sources.length)
                        return a.file = a.sources[0].file, a.feedData = n, function(t) {
            ...
            6886: function(t, e, n) {
                                        ...
                                        return function(t) {
                                            return function(e) {
                                                ...
                                                if (clearTimeout(t.timeoutId), t.responseType) {
                                                    ...
                                                    if (a && o)
                                                        return f(n, a, t);
                                                    if (t.useDomParser && n.responseText && !a && (a = (0, i.parseXML)(n.responseText)) && a.firstChild)
                                                        return f(n, a, t);
                ...
                function f(t, e, n) {
                    ...
                    if (!n.requireValidXML || "parsererror" !== i.nodeName && !i.getElementsByTagName("parsererror").length)
                        return t.responseXML || (t = (0, r.l7)({}, t, {
                            responseXML: e
                        })), n.oncomplete(t);
                    l(n, u.ul, 601)
                }
            ...
            9888: function(t, e, n) {
                ...
                var r = n(7034),
                    i = n(6042);
                function o(t, e) {
                    if (e && (0, r.exists)(e) || (e = document.location.href), !(0, r.exists)(t))
                        return "";
                    if (u(t))
                        return t;
                    var n,
                    ...
                    for (var c = [], s = 0; s < n.length; s++)
                        n[s] && (0, r.exists)(n[s]) && "." !== n[s] && (".." === n[s] ? c.pop() : c.push(n[s]));
                    return i + o + "/" + c.join("/")
                }
                function u(t) {
                ...
                function l(t, e) {
                    if ((0, i.i2)(t) && (t = parseInt(t.toString())), (0, i.i2)(t) || !isFinite(t) || t <= 0 && !e)
                        return "00:00";
                    var n = t < 0 ? "-" : "";
                    t = Math.abs(t);
                ...
                function f(t) {
                    if ((0, i.i2)(t) && (t = parseInt(t.toString())), (0, i.i2)(t) || !isFinite(t) || t <= 0)
                        return "0 seconds";
                ...
                function P(t) {
                    if (!t.handlers.init) {
                        var e = t.el,
                            ...
                            u = function(e) {
                                clearTimeout(s),
                                t.el && (A(t), O(t, h), t.dragged && (t.dragged = !1, _(t, i.Sv, e)))
                            };
                        x(t, v),
                        I(t, v, (function(i) {
                            if ((0, a.IV)(e, "jw-tab-focus"), !F(i)) {
                                ...
                                if (!t.directSelect || c === e) {
                                    ...
                                    if (t.dragged = !1, t.startX = f, t.startY = d, O(t, h), "pointerdown" === s && i.isPrimary) {
                                        ...
                                        "mousedown" === s ? (E(t, h, "mousemove", o, r), E(t, h, "mouseup", u)) : "touchstart" === s && (E(t, h, "touchmove", o, r), E(t, h, "touchcancel", u), E(t, h, "touchend", u))
                                }
                            }
                        }), r)
                    }
            ...
            4671: function(t, e, n) {
                ...
                e.Z = {
                    ...
                    addScrollHandler: function(t) {
                        p || (p = !0, window.addEventListener("scroll", y)),
                        s.push(t)
                    },
            ...
            817: function(t, e, n) {
                    ...
                    try {
                        ...
                        if (e && ("object" == typeof e || "function" == typeof e)) {
                            ...
                            if ("function" == typeof n)
                                return void d((r = n, i = e, function() {
                                    r.apply(i, arguments)
                                }), t)
                        }
                        t._state = 1,
                ...
                function _(t) {
                    ...
                    (0, r.l7)(this, {
                        ...
                        remove: function() {
                            return this.getPip() && this.setPip(!1), function(t) {
                ...
                (0, r.l7)(rt, V),
                I(rt),
                "function" == typeof nt.define && nt.define.amd && nt.define([], (function() {
                    return rt
                }));
                var it = rt;
            ...
            5592: function(t, e, n) {
                ...
                var r = n(5140),
                    ...
                    a = function(t, e) {
                        if (t = String(t), e = String(e), 0 === t.length)
                            return "";
    ...
    i.l = function(n, r, o, u) {
        if (t[n])
            ...
            a || (c = !0, (a = document.createElement("script")).charset = "utf-8", a.timeout = 55, i.nc && a.setAttribute("nonce", i.nc), a.setAttribute("data-webpack", e + o), a.src = n),
            t[n] = [r];
            var d = function(e, r) {
...
var jwDefaults = {
    ...
    "displaytitle": true,
    "height": 360,
    "key": "VLw0HPZZMhXzs/nYhtvBTnkzYOjcXJgfAYKLveA5/UCwBLw/u9Tswg==",
    "logo": {
        "file": "https://assets-jpcust.jwpsrv.com/watermarks/wdTEFLsx.png",
        "hide": false,
        "link": "https://www.pressurecookrecipes.com/",
        "margin": "10",
        "position": "top-left"
    },
    "mute": false,
